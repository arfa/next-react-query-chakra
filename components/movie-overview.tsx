import { Badge, Flex, Heading, Image, Stack, Text, useColorModeValue } from '@chakra-ui/react';
...
export const MovieOverview = ({ categories, description, picture, title }: MovieOverviewProps) => {
